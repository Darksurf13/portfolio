export const data = [
  ...
  },
  {
    ...
    description:
      "sur le portfolio de Sophie BLUEL,A l'aide de la documention SWAGGER FOURNIE : création d'une page connexion pour l'utilisateur, en mode connexion:,utilisatoin de JASON WEB TOKEN ,changer certains éléments de la page d'accueil,  :affichage des logements,création d'une modale qui affiche tous les logements pour pouvoir créer, modifier ou supprimer un logement",
  },
  {
    id: 4,
    title: "<strong>Solution technique </strong>pour le site menuMaker",
    description:
      "C'est une mission Frontend :  mener, préparer et planifier le projet de développement du site MenuMaker, permettant aux restaurateurs d’afficher et de mettre en page leurs menus facilement, en quelques clics. Pour cela à partir des documents fournis : la maquette,le document des spécifications fonctionnelles, le tableau des user stories sur notion, j'ai mis en place une veille technologique, les spécifications techniques,le KANBAN avec TRELLO et la solution technique.",
  },
  {
    id: 5,
    title:
    ...
    description:
      "<strong><mark>DEBBUGAGE</mark></strong> : <br/>Identification de 2 bugs au niveau de la gallery d'images: <br/>les boutons de la navigation ne se colorent pas au clic et en cliquant sur une image, les flèches directionnelles sont bloquées, ne pouvant pas passer d'une image à l'autre.     <br/><br/>     <strong><mark>OPTIMISATION:</strong></mark>  <br/> IMAGES  J'ai optimisé les images avec l'application en ligne squoosh.app : en les compressant,les redimensionnant et en les convertissant au format WEBP.<br/> J'ai utilisé l'attribut srcset sur 2 images pour leur adaptation sur mobile.<br/> J’ai rajouté l’attribut loading avec la valeur lazy aux images que l’on ne voit pas au chargement de la page pour qu’elle se charge lors de leur apparition  :<br/> <br/> <strong>BALISAGE SEO</strong> <br/>j'ai rajouté la balise d'en-tete  et la balise.<br/>J'ai inclus ses googles rich snippets(=contenus enrichis pour la recherche du site sur google et dans le but d’améliorer le <strong>référencement local </strong>(schéma.org).<br/> J'ai aussi rajouté la balise meta robots, la balise description, les balises metas de facebook et de twitter.<br/> J'ai rajouté l’attribut defer aux scripts pour un chargement différé.<br/> J’ai supprimé au maximum le code inutiisé à l’aide de l’outil COUVERTURE de GOOGLE DEV TOOLS pour certains fichiers et supprimés les fichiers qui ne servent à rien. <br/><br/><strong>ACCESSIBILITE:</strong><br/> J'ai améliorer l'accessibilité avec l'outil WAVE EVALUATION TOOLS :<br/>J’ai rajouté l’'attribut [lang] à la balise <HTML> . <br/>J’ai rajouté l’attribut ALT à toutes les images avec une description de chacune d’elle.<br/>J’ai changé la couleur du texte en noir du bouton par défaut de la lightbox.<br/>J’ai repris la structure des balises HTML pour incorporer un maximum de balises sémantiques à la place de la balise générique div.<br/>J’ai aussi repris les balises des titres en suivant un ordre cohérent.",
  },
  {
    id: 6,
    title: "Création d’un site web avec<strong> REACT.js </strong>",
    description:
      "Mission Frontend : Implémentation d'un site react.js à l'aide d'une maquette Figma.<br/>Installation de l'application avec CREATE REACT APP et de REACT ROUTER, du module SASS.<br/> <br/><u>Création de plusieurs pages :</u> <br/><mark><strong> page Home </strong></mark><br/> avec les cartes des logements, <br><mark><strong> page page Logement </strong></mark>: <br/>avec les détails du logement et notamment le composant Carrousel<br/><mark><strong> page à propos</strong></mark>:<br/> avec le composant Collapse <br/> <mark><strong> page404 </strong></mark> <br/> Lorsqu'une page n'existe pas, il y a une redirection automatique vers la page 404",
  },
  {
    id: 7,
    title:
